...
### Apache / localhost:8080 note

If you browse to `http://localhost:8080/sim_harness/`, Apache may return `403 Forbidden` when no index file is present or directory listing is disabled.
Use the Python UI server instead:
